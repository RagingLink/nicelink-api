...
text|txt|`undefined`|Can be an array of objects, a single object or a string with the text to display. **It's recommended to provide an object for more control of the text. For information about the supported properties visit the [text](https://api.nicelink.xyz/docs/jimp#supported-text-properties) section**
