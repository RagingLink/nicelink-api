...
export default class SharpRoute {
    ...
    public constructor(public readonly logger: DefaultLogger, public readonly env: NodeJS.ProcessEnv, public readonly config: Config) {
        this.router = Router();
        ...
        new SharpDiscord(logger, config);
    ...
    private storeImage(req: Request, res: Response): void {
        ...
        const permanent = 'persistKey' in body && body.persistKey === this.config.persistKey;
